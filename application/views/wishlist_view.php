...
<?php $wish=""; ?>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <?php foreach($wishlist as $key=>$value){?>
                            <div class="innerhead">
                                <h2>Wishlist Name :<?php echo $value->created_wishlist_name;?></h2>
                                <p style="color: white">Description :<?php echo $value->wishlist_desc;?></p>
                            </div>
                        <?php $wish = $value->created_id; }  ?>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="block">
            <div class="container">
                ...
                <div class="pactions" style="margin-left: 900px">
                    <a href="<?php echo base_url(); ?>index.php/ItemListController/testWishlist" title="">Create a New Wishlist</a>
                </div>
                <div class="grids-sec">
    ...
    <footer>
        <div class="bottomline">
            <div class="container">
                <span>© 2019 Wishlist. All rights reserved!.</span>
            </div>
        </div>
    </footer>
</div>
