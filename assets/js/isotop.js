...
$(window).load(function () {
    ...
    $portfolio.isotope({masonry: {columnWidth: 0}});
    var $portfolio3 = $('#masonry2');
    $portfolio3.isotope({masonry: {columnWidth: 0}});
    var $portfolio4 = $('#masonry3');
    $portfolio4.isotope({masonry: {columnWidth: 0.5}});
    var $portfolio5 = $('#masonry4');
    $portfolio5.isotope({masonry: {columnWidth: 0.5}});
    var $portfolio6 = $('#masonry5');
    $portfolio6.isotope({masonry: {columnWidth: 1}});
    var $portfolio2 = $('#resproduct');
    $portfolio2.isotope({masonry: {columnWidth: 0}});
